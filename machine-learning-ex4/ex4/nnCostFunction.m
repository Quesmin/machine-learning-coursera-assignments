...
J = J/m + ((sum(Theta1_cpy(:).^2) + sum(Theta2_cpy(:).^2))*lambda)/(2*m);
...
%D1(1, :) = delta1(1, :)/m;
%D1(2:end, :) = delta1(2:end, :)/m + lambda*Theta1(2:end, :);

%D2(1, :) = delta2(1, :)/m;
%D2( 2:end, :) = delta2(2:end, :)/m + lambda*Theta2(2:end, :);
